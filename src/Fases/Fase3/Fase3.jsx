...
function Fase3(props) {
    ...
    const [vidaRato, setVidaRato] = useState(19)
    ...
    function acoesTurno(dano, mana, nome) {
        if (manaHeroi - mana < 0) {
            ...
            if (vidaRato - dano <= 0) {
                ...
                props.setJogador({ nome: props.jogador.nome, pontuacao: props.jogador.pontuacao + 60 })
            } else {
                acaoInimigo(nome)
            }
        }
            ...
            <div className="background">
                ...
                <div className="background-luta">
                    ...
                    <div className='luta'>
                        ...
                        <div className="personagem">
                            <div className="imagem-personagem">
                                <img src={rataoArmadura} id="aumenta" alt="Rato Bebê" />
                            </div>
                        </div>
                    </div>
